...
fun ArtSpaceLayout(
    ...
    val imageTitle = when (currentArtwork) {
        1 -> R.string.backround_1_title
        2 -> R.string.backround_2_title
        else -> R.string.backround_3_title
    }

    val imageArtist = when (currentArtwork) {
        1 -> R.string.backround_1_artist
        2 -> R.string.backround_2_artist
        else -> R.string.backround_3_artist
    }
